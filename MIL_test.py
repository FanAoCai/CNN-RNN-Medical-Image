...
parser.add_argument('--lib', type=str, default='7cls_data/test_data_7cls', help='path to data file')
...
parser.add_argument('--batch_size', type=int, default=8, help='how many images to sample per slide (default: 100)')
