...
parser.add_argument('--lib', type=str, default='7cls_data/test_data_7cls', help='path to train MIL library binary')
...
parser.add_argument('--model', type=str, default='checkpoint_best.pth', help='path to trained model checkpoint')
parser.add_argument('--rnn', type=str, default='rnn_checkpoint_best.pth', help='path to trained RNN model checkpoint')
